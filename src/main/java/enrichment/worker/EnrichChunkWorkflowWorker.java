...
import enrichment.workflow.EnrichChunkWorkflow;
import enrichment.workflow.EnrichChunkWorkflowImpl;
import io.temporal.client.WorkflowClient;
import io.temporal.serviceclient.WorkflowServiceStubs;
import io.temporal.worker.Worker;
import io.temporal.worker.WorkerFactory;

public class EnrichChunkWorkflowWorker {
    public static void main(String[] args) {
        ...
        worker.registerWorkflowImplementationTypes(EnrichChunkWorkflowImpl.class);
